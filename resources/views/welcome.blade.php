...
<head>
    ...
    <title>Administrasi Persuratan</title>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/img/favicons/favicon.svg') }}">
            ...
            <div class="container">
                <div class="row gy-4 justify-content-between">
                    ...
                    <div class="col-lg-6  d-flex flex-column justify-content-center" data-aos="fade-in">
                        <h1>FLIMS <span>Administrasi Persuratan</span></h1>
                        <h1></h1>
