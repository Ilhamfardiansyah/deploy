...
@section('content')
    ...
    <div class="col-log-12">
        <div class="card">
            <div class="card-body">
                <h3 class="card-title text-center">EDIT DATA PEJABAT</h3>

                <form action="{{ route('updatePejabat', $pejabat->id) }}" method="POST">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="pangkat" id="pangkat"
                                ...
                                value="{{ old('pangkat', $pejabat->pangkat) }}">
                            @error('pangkat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <a href="{{ route('dataPejabat') }}" role="button" class="btn btn-secondary">Back</a>
            </div>
