...
@section('content')
    ...
    <div class="col-log-12">
        <div class="card">
            <div class="card-body">
                <h3 class="card-title text-center">Data Master Petugas</h3>
                        ...
                        @foreach ($petugas as $data)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('editPetugas', $data->id) }}"
                ...
                <a class="btn btn-success bi bi-person-plus-fill" href="{{ route('storeMasterPetugas') }}">Tambah
                    Anggota</a>
            </div>
        </div>
    </div>
